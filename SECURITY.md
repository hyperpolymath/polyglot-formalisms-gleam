...
Replace all {{PLACEHOLDER}} values with your information:
  Polyglot Formalisms Gleam     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  polyglot-formalisms-gleam             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories/new)
...
- This repository (`hyperpolymath/polyglot-formalisms-gleam`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories)
...
When using Polyglot Formalisms Gleam, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/polyglot-formalisms-gleam/discussions) |
...
*Thank you for helping keep Polyglot Formalisms Gleam and its users safe.* 🛡️
