...
toolbox create polyglot_formalisms_gleam-dev toolbox enter
polyglot_formalisms_gleam-dev # Install dependencies manually
...
polyglot_formalisms_gleam/ ├── src/ # Source code (Perimeter 1-2) ├──
