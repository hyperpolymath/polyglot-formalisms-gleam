...
[arabic]
. Navigate to
https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/polyglot-formalisms-gleam+`) and all
its code
...
https://github.com/hyperpolymath/polyglot-formalisms-gleam/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/polyglot-formalisms-gleam/discussions[GitHub
Discussions]
...
_Thank you for helping keep Polyglot Formalisms Gleam and its users
safe._ 🛡️
