...
# Contributing — polyglot-formalisms-gleam

## Audience

Developers working **on** `polyglot-formalisms-gleam`. For consumers
(people calling or depending on it) see
...
``` bash
git clone git@github.com:hyperpolymath/polyglot-formalisms-gleam.git
cd polyglot-formalisms-gleam
...
- Bugs in `polyglot-formalisms-gleam`: file at
  `hyperpolymath/polyglot-formalisms-gleam/issues`.
