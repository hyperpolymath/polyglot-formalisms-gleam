{
  description = "polyglot-formalisms-gleam - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 polyglot-formalisms-gleam development environment"
            echo "Language: gleam"
            echo ""
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "polyglot-formalisms-gleam";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P polyglot-formalisms-gleam.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/polyglot-formalisms-gleam $out/bin/  # Rust
            # cp bin/polyglot-formalisms-gleam $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/polyglot-formalisms-gleam";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-polyglot-formalisms-gleam" {
