...
// Replace polyglot-formalisms-gleam, Polyglot Formalisms Gleam — See README.adoc for details., just run, Polyglot Formalisms Gleam started successfully. with actuals
= polyglot-formalisms-gleam — Quick Start for Users
:toc:
:toclevels: 2

== What is polyglot-formalisms-gleam?

Polyglot Formalisms Gleam — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./polyglot-formalisms-gleam-portable
----
...
[source]
----
Polyglot Formalisms Gleam started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/polyglot-formalisms-gleam/wiki
