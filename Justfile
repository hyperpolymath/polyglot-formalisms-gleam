...
# Justfile for polyglot-formalisms-gleam
...
doctor:
    @echo "Running diagnostics for polyglot-formalisms-gleam..."
...
tour:
    @echo "=== polyglot-formalisms-gleam Tour ==="
    @echo ""
...
help-me:
    @echo "=== polyglot-formalisms-gleam Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/polyglot-formalisms-gleam/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: polyglot-formalisms-gleam"
